...
- [ ] 待查：p26 runtime margin 口径差（open item，见 `.agent/STATE.md` 2026-09-06(XIII)）。
...
- [ ] 待用户逐段人工复核：test1-3 GT 草案（见本文件 2026-09-02 条目）。

## P2 — Later

- [ ] 本文件已达 86 KB / 815 行，与协议「TODO 保持短小、不重复长篇说明」不符；
