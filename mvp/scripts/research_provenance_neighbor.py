"""Phase 24-2 · 原片邻接唯一性探针 M8 —— 来源身份信息(provenance)能否消歧失败族。
...
CASES = [
    ("2mkv", "p38", (1048, 1050), (1108, 1110), "兄弟机位: 士兵特写(真值) vs 瞭望塔(干扰)"),
    ("2mkv", "p08", (1108, 1110), (1048, 1050), "兄弟机位: 瞭望塔(真值) vs 士兵特写(干扰)"),
    ("2mkv", "p26", (2808, 2811), (1766, 1770), "夜读(真值) vs 夜阳台(干扰)"),
    ("test3", "t3r12", (454, 480), (481, 488), "精灵王重复镜头(真值) vs 另一实例(干扰)"),
    ("test4", "t4r01", (3329, 3355), (3355, 3398), "同质滑梯(真值) vs 紧邻同质干扰"),
]
...
def main() -> int:
    ...
    out = WORK / "provenance_neighbor_results.json"
